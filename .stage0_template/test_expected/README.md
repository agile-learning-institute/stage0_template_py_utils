...
**Developer Edition:** Domain APIs and this library **validate** JWTs issued by the welcome page / IdP; they do not expose HTTP endpoints that mint credentials. See [API Standards](https://github.com/agile-learning-institute/mentorhub/blob/main/DeveloperEdition/standards/api_standards.md).
...
pipenv install git+https://github.com/agile-learning-institute/api_utils.git
```

**Development Installation (Editable Mode):**
```bash
pipenv install -e git+https://github.com/agile-learning-institute/api_utils.git#egg=api-utils
```
