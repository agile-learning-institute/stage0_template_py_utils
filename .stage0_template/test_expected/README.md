...
**Developer Edition:** Domain APIs and this library use JWTs from the welcome page / IdP, not an API-hosted dev-login. See [API Standards](https://github.com/agile-learning-institute/mentorhub/blob/main/DeveloperEdition/standards/api_standards.md).
